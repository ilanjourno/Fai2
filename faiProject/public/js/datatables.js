 ...
 *   https://datatables.net/download/#bs4/jq-3.3.1/dt-1.10.21/r-2.2.5/sp-1.1.1
 *
 * Included libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.21, Responsive 2.2.5, SearchPanes 1.1.1
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( lang ) {
			...
			if ( ! lang.sEmptyTable && zeroRecords &&
				defaults.sEmptyTable === "Pas de donnée dans ce tableau" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Pas de donnée dans ce tableau
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Pas de donnée dans ce tableau"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Pas de donnée dans ce tableau",
			 ...
			 *    } );
			 */
			"sInfo": "Tableau de _START_ à _END_ sur _TOTAL_ resultats",
			 ...
			 *    } );
			 */
			"sLengthMenu": "   Limite d'affichage: _MENU_ ",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/jq-3.3.1/dt-1.10.21/r-2.2.5/sp-1.1.1",
