...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Ceci est ta page de profil. Tu peux modifier ton profil avec ton nom, email et mot de passe'),
        'class' => 'col-lg-10'
    ])   
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-current-password">{{ __('Mot de passe acutel') }}</label>
